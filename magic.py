...
def exiting_loading_screen():   
  ...
  loading_text = '''                 
    ______      _                            _                           
   / __/ /_  __(_)___  ____ _   __  ______  (_)________  _________  _____
  / /_/ / / / / / __ \/ __ `/  / / / / __ \/ / ___/ __ \/ ___/ __ \/ ___/
 / __/ / /_/ / / / / / /_/ /  / /_/ / / / / / /__/ /_/ / /  / / / (__  ) 
/_/ /_/\__, /_/_/ /_/\__, /   \__,_/_/ /_/_/\___/\____/_/  /_/ /_/____/  
      /____/        /____/                                                                                                                              '''   
...
def sslscan_scan():   
  ...
  if ip:   
    ...
    try:   
      ...
      print("5. Vuln Scan")  # Added new option   
      ...
      if choice == '1':   
        ...
        command = f"nmap --script=vuln --bugs {ip}"  # New command for Vuln Scan   
      else:   
